//只做出了基本效果，写到后面的要做数据存储的时候发现自己的思路不太对，编程能力非常欠缺，不过也经过这次项目得到了锻炼，
//了解到一个写好HTML结构对后来写JS有多重要，因为反复改了很多次。发现自己水平实在欠缺，之后的学习中一定会尽力赶上，这次
//练习实在是尽力了，但是由于很多技巧和思维的欠缺浪费了很多时间，希望老师能给我机会继续学习。我还会继续完善这个项目的
